...
export default function WomensScholarshipPage() {
  return (
      ...
      <div className="w-full bg-[#F1F1E6] py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 space-y-8">
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <ChevronRight className="h-4 w-4" />
            <span className="text-foreground">Women's Scholarship for International Students 2026</span>
          </div>

          {/* Header Section */}
          <div className="space-y-4 text-left">
            <h1 className="text-4xl md:text-5xl font-bold text-[#424242]">
              Women's Scholarship for International Students 2026
            </h1>
            <p className="text-lg text-muted-foreground">
              Apply for our $5,000 scholarship and let us help make your study abroad dreams a reality!
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-3 relative w-full h-64 md:h-96 rounded-lg overflow-hidden">
              <Image
                src={womensScholarship}
                alt="Women's Scholarship for International Students 2026"
                fill
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-[#424242]">Women pursuing international studies</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6 text-[#424242]">
            <div>
              <h2 className="text-2xl font-bold mb-4">Empowering Women in International Education</h2>
              <p className="text-base leading-relaxed mb-4">
                At educations.com, we believe that education knows no boundaries and that women should have equal opportunities to pursue their academic dreams globally. This scholarship is designed to support and empower women who are passionate about studying abroad.
              </p>
              <p className="text-base leading-relaxed mb-4">
                We're awarding one scholarship worth up to $5,000 to support tuition costs for women beginning their studies abroad in Fall 2026 or later, at any level (Bachelor's, Master's, or Doctoral).
              </p>
              <p className="text-base leading-relaxed mb-4">
                Whether you're pursuing undergraduate studies, a Master's degree, or a PhD—this opportunity is here to support your educational journey and help you achieve your goals.
              </p>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-base leading-relaxed ml-4">
                ...
                <li>You must have applied (or will apply) to a university or college outside your home country.</li>
                <li>You must have applied (or will apply) for a degree program starting in the Fall of 2026 or later.</li>
                <li>The degree program can be at any level: Bachelor's, Master's, or Doctoral.</li>
                <li>You must meet the entry requirements for the university or college of your choice, including:
                  <ul className="list-disc list-inside space-y-1 ml-6 mt-2">
                    <li>Meeting academic requirements for your level of study</li>
            ...
            <div>
              ...
              <p className="text-base font-semibold mb-4">Are you a trailblazing woman ready to study abroad?</p>
              <p className="text-base leading-relaxed mb-4">
                If you're a woman looking for a scholarship to study abroad, we know you're well on your path to achieving your educational goals. Having taken this leap, it's clear that you have a courageous and determined spirit.
              </p>
              <p className="text-base font-semibold mb-2">We're looking for candidates who are:</p>
              <ul className="list-disc list-inside space-y-2 text-base leading-relaxed ml-4">
                <li>Passionate about pursuing their education internationally</li>
                <li>Committed to breaking barriers and achieving academic excellence</li>
            ...
            {/* Key dates */}
            <div>
              <h2 className="text-2xl font-bold mb-4">Key dates for the 2026 Women's Scholarship</h2>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-base leading-relaxed ml-4 mb-4">
                ...
                <li>Proof of academic qualifications in the form of a copy of your transcripts</li>
